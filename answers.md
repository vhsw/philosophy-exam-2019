...
Исследуемый объект отражается преимущественно со стороны своих внешних проявлений,
...
1. Ощущение --- отражение в сознании человека отдельных свойств предметов, непосредственное
воздействие их на органы чувств
...
>Гипотеза --- предположение, сформулированное на основе ряда фактов, истинное значение которого неопределенно и нуждается в доказательстве. Гипотетическое знание носит вероятный характер и требует обоснования
...
* В *гносеологическом* --- это система принципов, которые определяют направления и методы научного познания и являются формами синтеза научного знания. Примеры: атомизм, детерминизм
...
1. Логические --- правила абстрагирования, образования исходных
и производных понятий, правила вывода
...
Такая постановка проблемы методологии науки, выводит на первый план исследование исторических, социальных и психологических условий производства нового знания. Подобным образом эти
проблемы рассматривают представители так называемого постпозитивизма --- Кун, Фейерабенд, Лакатос.
...
Разновидностью гипотетико-дедуктивного метода можно считать математическую гипотезу, где в
качестве гипотез выступают некоторые уравнения, предоставляющие модификацию ранее известных и
проверенных состояний. Изменяя последние, составляют новое уравнение, выражающее гипотезу, которая
относится к новым явлениям.
...
1. Абстрактно-общее как простая одинаковость, внешнее сходство. Данный вид всеобщего, выделенного путем сравнения, играет в познании важную, но ограниченную роль
1. Конкретно-общее как закон существования и развития ряда единичных явлений в их взаимодействии в составе целого. Данный вид общего выражает внутреннюю, повторяющуюся у группы сходных явлений основу --- сущность в ее развитой форме
...
1. выявление зависимости каждого элемента от его места и функций в системе с учетом того, что
свойства целого несводимы к сумме свойств его элементов
1. анализ того, насколько поведение системы обусловлено как особенностями ее отдельных элементов,
так и свойствами ее структуры
...
1. рассмотрение развития (истории) системного объекта в целом
